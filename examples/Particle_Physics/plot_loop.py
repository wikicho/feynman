...
w1 = diagram.line(v1, v2, shape='elliptic', ellipse_excentricity=1.0, arrow=True)
w2 = diagram.line(v2, v1, shape='elliptic', ellipse_excentricity=1.0, arrow=True)
...
w1.text(r"$X$",              .45,  .054, **opts)

diagram.plot()
plt.savefig("./results/loop-diagram-2to2-s.pdf")
#plt.show()
